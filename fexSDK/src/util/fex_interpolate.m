...
%
%
% FEX_INTERPOLATE interpolates timeseries and recovers NaNs.
%
%
% SYNTAX:
%
...
% Additionally, FEX_INTERPOLATE recover missing values in the time series
% using interpolation.
%
% Input arguments:
% 
...
% DSP  - [vector,required] number of datapoints per second, a.k.a fixed
...
% Output arguments:
%
% NDATA -  [matrix or vector] new datamatrix. NTSP  -  [vector] new vector
%          of timestamps.
% NFR   -  [vector] since the new matrix may be longer than
%          the original dataset, there will be more datapoints than the one
%          originally acquired (i.e. 1:length(data)). nfr indicates a
%          correspondence between rows in data and rows in ndata.
% NAN_INFO - information about number and duration of null events. It's a
%          N*2 matrix, the first column tags adjacent null obesrvations and the
%          second column indicate how many adjacent Nans ther are.
%
%
%
